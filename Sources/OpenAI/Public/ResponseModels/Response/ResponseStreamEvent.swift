...
public struct FunctionCallArgumentsDoneEvent: Decodable {
  ...
  public let itemId: String
  public let outputIndex: Int
  /// The name of the function being called. May be nil in some streaming scenarios.
  public let name: String?
  /// The complete JSON arguments for the function call. May be nil in some streaming scenarios.
