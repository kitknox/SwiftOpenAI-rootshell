...
public struct StreamOptions: Codable {
  ...
  /// Codex backend: "sequential_cutoff" lets the server stream output without waiting on reasoning-summary completion.
  public var reasoningSummaryDelivery: String?

  public init(includeObfuscation: Bool? = nil, reasoningSummaryDelivery: String? = nil) {
