...
public struct Reasoning: Codable {
  public init(effort: String? = nil, summary: Summary? = nil, context: String? = nil) {
    self.effort = effort
  ...
  /// Codex backend: how much prior reasoning the model may consider. One of auto, current_turn, or all_turns.
